 ...
 */
public class AStar {
    private static int DEFAULT_HV_COST = 15; // Horizontal - Vertical Cost
    ...
    public void setBlocks(int[][] blocksArray) {
        System.out.println("dit is blocksarray " + blocksArray.length);
        for (int i = 0; i < blocksArray.length; i++) {
            int row = blocksArray[i][0];
            System.out.println("dit is de row " + row);
            int col = blocksArray[i][1];
            System.out.println("dit is de col " + col);
            setBlock(col, row);
        }
    }
